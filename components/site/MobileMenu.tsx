        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-72 bg-ivory p-6 animate-[fadeIn_.2s_ease] shadow-luxe">
            <div className="flex items-center justify-between mb-6">
              <Link href="/shop" onClick={() => setOpen(false)} className="font-display text-2xl text-ink">Newvora</Link>
            ...
            <nav className="space-y-1">
              ...
              <Link href="/track" onClick={() => setOpen(false)} className="block py-2 text-ink/80">Track my order</Link>

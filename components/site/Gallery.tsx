...
const GRADS = [
  "linear-gradient(135deg,#DDD6FE,#F1F5F9,#FCD34D)",
  "linear-gradient(135deg,#6366F1,#EEF0FF,#F59E0B)",
  "linear-gradient(135deg,#FCD34D,#F8FAFC,#6366F1)",
  "linear-gradient(135deg,#F1F5F9,#DDD6FE,#F59E0B)",
];

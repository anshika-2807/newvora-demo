  ...
  return (
    <footer className="bg-night text-onnight/80 mt-20">
      <div className="max-w-7xl mx-auto px-5 py-14 grid md:grid-cols-4 gap-10">
        <div>
          <Link href="/" className="font-display text-3xl text-onnight inline-block">Newvora</Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/quote" className="hover:text-gold transition-colors">Bulk / business quote</Link></li>

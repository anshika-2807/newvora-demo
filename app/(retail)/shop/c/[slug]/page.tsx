...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: `Shop ${name.toLowerCase()} from Newvora, Sadar Bazar Delhi. Premium artificial ${name.toLowerCase()} at retail & wholesale, with COD and free shipping over ₹999.`,

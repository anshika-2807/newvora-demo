    ...
    <main className="p-8 bg-cream/40 min-h-screen max-w-3xl">
      ...
      <div className="bg-surface rounded-2xl p-6 shadow-card mb-6">
        ...
        <form action={createReelAction} className="space-y-3">
          <input name="caption" placeholder="Caption (e.g. New arrivals ✨)" className={input} />
          <div>
      ...
      <div className="space-y-3">
        {reels.map((r: any) => (
          <div key={r.id} className="bg-surface rounded-2xl p-5 shadow-card flex items-center justify-between gap-4">

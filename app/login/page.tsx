    ...
    <main className="min-h-screen grid place-items-center bg-gradient-to-b from-cream to-ivory px-5">
      <div className="w-full max-w-sm">
        ...
        <form action={loginAction} className="bg-white rounded-2xl shadow-luxe p-7">
          ...
          <p className="text-xs text-muted mb-5">Enter your owner passcode to access the console.</p>
          <input type="hidden" name="next" value={searchParams.next ?? "/admin/dashboard"} />
          <input name="passcode" type="password" autoFocus placeholder="Passcode"
          ...
          <p className="text-[11px] text-muted/70 mt-4 text-center">Demo passcode: <span className="font-mono">blythe2026</span> · change via OWNER_PASSCODE</p>
        </form>
      </div>
    </main>
  );

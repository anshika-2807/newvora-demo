    ...
    <main className="min-h-screen grid place-items-center bg-gradient-to-b from-cream to-ivory px-5">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          <p className="font-display text-4xl text-ink">Newvora</p>
          <p className="text-[10px] tracking-[0.3em] uppercase text-gold-dark mt-1">Owner Console</p>
        </div>
        <form action={loginAction} className="bg-surface rounded-2xl shadow-luxe p-7">
          ...
          <input name="passcode" type="password" autoFocus placeholder="Owner or staff passcode"
            className="w-full rounded-xl border border-sand px-4 py-2.5 text-sm bg-surface outline-none focus:border-emerald transition-colors" />
          ...
          <p className="text-[11px] text-muted/70 mt-4 text-center">Owner demo passcode: <span className="font-mono">demo2026</span> · staff passcodes are on the Roles page</p>
        </form>
      </div>
    </main>
  );

...
export default function Home() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-20 text-center">
      <p className="text-diva-gold tracking-[0.3em] text-xs uppercase mb-3">Newvora</p>
      <h1 className="font-serif text-5xl text-diva-ink mb-4">Newvora</h1>
      <p className="text-diva-ink/70 mb-10">Artificial jewellery — retail &amp; wholesale. Delhi, India.</p>
